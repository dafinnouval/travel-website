    ...
    <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
        ...
        <tbody>
          <tr>
            <td
              style="border-bottom:1px dashed #aaa;direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0px;padding-top:0px;text-align:center;">
                          ...
                          <tbody>
                            <tr>
                              <td style="width:150px;">
                                <img height="auto" src="{{ url('frontend/images/logo@2x.png') }}"
                          ...
                          <tbody>
                            <tr>
                              <td style="width:550px;">
                                <img height="auto" src="{{ url ('storage/'.$data->travel_package->galleries[0]->image) }}"
                                  style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                  width="550" />
                              </td>
                            </tr>
            ...
            <td
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix"
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                  <tbody>
                    <tr>
                      <td style="border-bottom:1px dashed #aaa;vertical-align:middle;padding-bottom:30px;">
                          ...
                          <tbody>
                            <tr>
                              <td align="left"
                                ...
                                <div
                                  style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:22px;text-align:left;color:#071C4D;">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="center" bgcolor="#FF9E53" role="presentation"
                                        style="border:none;border-radius:6px;cursor:auto;mso-padding-alt:10px 25px;background:#FF9E53;"
                                        valign="middle">
                                        <a href="{{ url('checkout/' .$data->id) }}"
                                          style="display:inline-block;background:#FF9E53;color:#ffffff;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:6px;">
                                          Check Details </a>
                                      </td>
                                    </tr>
                                  </tbody>
                    ...
                    <tr>
                      <td align="left"
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" border="0"
                          ...
                          <tr>
                            <td style="width: 50px;">
                              <img src="{{url ('frontend/images/ic_mail@2x.png') }}" width="50px">
                            </td>
                            <td
                              style="font-size: 18px; padding-left: 10px; font-family: Assistant, Helvetica, Arial, sans-serif">
                              support@nomads.id <br> 021-2021-2022 </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
