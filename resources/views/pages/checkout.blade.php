      ...
      <div class="row">
        <div class="col-lg-8 pl-lg-0">
          <div class="card card-details">
            ...
            <h1>Who is Going?</h1>
            <p>
                Trip to {{ $item->travel_package->title }}, {{ $item->travel_package->loaction }}
            </p>
            <div class="attendee">
            ...
            <div class="member mt-3">
              <h2>Add Member</h2>
              <form class="row row-cols-lg-auto g-2 align-items-center" method="POST" action="{{ route('checkout-create', $item->id) }}">
                @csrf
                <div class="col-auto">
                ...
                <div class="col-auto">
                  <label class="visually-hidden" for="nationality">Nationality</label>
                  <div class="input-group">
                    <input 
                      type="text"
                      name="nationality" 
                ...
                <div class="col-auto">
                  <label class="visually-hidden" for="is_visa">Visa</label>
                  <select 
                ...
                <div class="col-auto">
                  <label class="visually-hidden" for="doe_passport">DOE Passport</label>
                    <div class="input-group mb-2 mr-sm-2 gj-datepicker">
                      <input 
                      type="text"
                      name="doe_passport" 
