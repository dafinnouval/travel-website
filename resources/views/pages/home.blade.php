        ...
        <div class="col-sm-6 col-md-6 col-lg-4">
          <div class="card card-testimonial text-center">
            <div class="testimonial-content">
              ...
              <p class="testimonial">
                " It was glorius and I could not stop to say wohoo for every single moment"
              </p>
            </div>
            <hr>
        ...
        <div class="col-sm-6 col-md-6 col-lg-4">
          <div class="card card-testimonial text-center">
            <div class="testimonial-content">
              ...
              <p class="testimonial">
                " The trip was amazing and i saw something beautiful in that island thats makes me want to learn more"
              </p>
            </div>
            <hr>
            <p class="trip-to mt-2">
