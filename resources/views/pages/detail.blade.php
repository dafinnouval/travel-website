      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-lg-8 pl-lg-0">
            ...
            @if ($item->galleries->count())    {{-- kondisi --}}
              <div class="gallery">
                  ...
                  @foreach ($item->galleries as $gallery)
                    <a href="{{ Storage::url($gallery->image) }}">
                      <img 
                        ...
                        class="xzoom-gallery" 
                        width="128"
                        xpriview="{{ Storage::url($gallery->image) }}"
                      />
                  </a>
                  @endforeach
              </div>
        ...
        <div class="col-lg-4">
          ...
          <div class="join-container d-grid gap-2">
            @auth
                <form action="{{ route('checkout_process', $item->id) }}" method="POST" class="d-grid">
                    @csrf
...
@push('prepend-style')
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/xzoom@1.0.15/dist/xzoom.min.js">
@endpush
